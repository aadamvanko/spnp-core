...
public class FunctionDefinitionVisitorImplTest {
    ...
    public void testVisit() {
        String expected = String.format("int intFunc() {%nreturn 0;%n}%n");
        ...
        reinitVisitor();
        expected = String.format("void voidFunc() {%nreturn;%n}%n");
        ...
        reinitVisitor();
        expected = String.format("double doubleFunc() {%nreturn 1.0;%n}%n");
        ...
        reinitVisitor();
        expected = String.format("string stringFunc() {%nreturn \"test\";%n}%n");
        ...
        reinitVisitor();
        expected = String.format("char charFunc() {%nreturn 'c';%n}%n");
